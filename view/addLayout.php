               ...
               <div class="container">
                  ...
                  <div class="row">
                     <div class="col-md-12 form-mp">
                        <form enctype="multipart/form-data" method="post" action="/function/layout/postLayout.php" id="addLayout" class="form-horizontal">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-5">
                                 <input type="text" name="title" class="form-control" placeholder="Layout name..">
                              </div>
                           </div>
                           <div class="form-group has-feedback">
                              <label class="col-sm-2 control-label">Layout</label>
                              <div class="col-sm-5">
                                 <input type="file" class="form-control" name="image" placeholder="Choose Layout..">
                              </div>
                           </div>  
                           <div class="form-group positionform">
                              ...
                              <div class="col-xs-2">
                                <input type="text" name="y[]" class="form-control" placeholder="y Position">
                              </div>
                              <div class="col-xs-1">
                           ...
                           <div class="form-group hide positionform" id="optionTemplate">
                              <label class="col-xs-2 control-label">Position</label>
                              <div class="col-xs-2 firstcol">
                                 <input type="text" class="form-control" name="x[]" placeholder="x Position"/>
                              </div>
                           ...
                           <div class="form-group">
                              <label for="" class="col-sm-2"></label>
                                 <div class="col-sm-3">
                                     <input type="submit" value="Add Layout" class="btn btn-blue btn-block">
                                 </div>
                           </div>
                        </form>
                     </div>
