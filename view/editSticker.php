...
?>
     ...
     <?php 
                  ...
                  $sticker = getStickerGroupDetail($group);
     ...
     ?>                 
                  <div class="row">
                     <div class="col-md-12 form-mp">
                        <form enctype="multipart/form-data" method="post" action="/function/sticker/putSticker.php" id="addStickerGroup" class="form-horizontal">
                           <div class="form-group has-feedback">
                              <label class="col-sm-2 control-label">Sticker Group Name</label>
                              <div class="col-sm-5">
                                 <input disabled type="text" class="form-control" name="name" value="<?php echo $stickerGroupName ?>">
                                 <input type="hidden" class="form-control" name="id" value="<?php echo $group ?>">
                           ...
                           <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-5">
                                 <input type="text" class="form-control" name="name" value="<?php echo $stickerData['name'] ?>">
                              </div>
                           </div>
                           ...
                           <div class="form-group has-feedback">
                              ...
                              <div class="col-sm-5">
                                <img src="<?php echo $stickerData['url'] ?>" width="100px"><br/><div class="mb10"></div>
                                 <input type="file" class="form-control" name="image" placeholder="Choose Photo..">
                                 <input type="hidden" type="id" name="oldimage" value="<?php echo $stickerData['url'] ?>"  />
                              </div>
                           </div>                        
                           <div class="form-group">
                              <label for="" class="col-sm-2"></label>
                                 <div class="col-sm-3">
                                     <input type="submit" name="" value="Edit Sticker" class="btn btn-info btn-block">
                                 </div>
                           </div>
                        </form>
                     </div>
