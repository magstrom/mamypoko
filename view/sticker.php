       ...
       <div class="modal-dialog">
         <div class="modal-content">
                 <div class="modal-header">
                   ...
                   <h4 class="modal-title" id="myModalLabel">Hapus Sticker dari List ?</h4>
                 </div>
               ...
               <div class="container">
                  ...
                  <div class="row">
                     <div class="col-md-12 table-mp">
                        <a href="/view/addSticker.php?id=<?php echo $id  ?>" class="btn btn-info"><i class="fa fa-plus"></i> Add New Sticker</a>
                        <div class="mt20"></div>
                        ...
                        <table class="table table-hover">
                           ...
                           <tbody>
                            <?php 
                             ...
                             ?>
                              <tr>
                                 <td><img src="<?php echo $item['url']?>" width="auto" height="50" alt=""></td>
                                 <td><?php echo $item['name']?></td>
                                 <td><a href="/view/editSticker.php?id=<?php echo $item['id'] ?>&group=<?php echo $id ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i> Edit </a>&nbsp; <a href="#"  class="btn btn-xs btn-danger del-tb" data-name="<?php echo $item['name'] ?>" data-group="<?php echo $id ?>" data-id="<?php echo $item['id'] ?>"><i class="fa fa-trash"></i> Delete </a></td>
                              </tr>
                              <?php     } ?>
...
<script>
   ...
   $(document).on("click", ".del-tb", function() {
      ...
      $('#yesDeleteSticker').attr('href', '/function/sticker/removeSticker.php?id=' +idProduct + '&group=' + group);
    });
